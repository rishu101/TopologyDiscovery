...
var Topology = function(me, peers) {
  ...
  var eventListner = function eventListner() {
    console.log(nodeName, 'is listening');
  }
  this.me = me || '';
  this.peers = {};
  this.server = null;
...
Topology.prototype.addListener = function() {
  // var listener = 
};

Topology.prototype.modifyName = function(name) {
  console.log("previous name: ", this.nodeName)
  this.nodeName = name
  console.log("name changed: ", this.nodeName)
}
